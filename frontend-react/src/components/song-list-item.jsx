...
class SongListItem extends React.Component {
    ...
    componentWillMount() {
        if (
            !this.props.songData.Artwork &&
            !this.props.songData.fetchingArtwork &&
            !this.props.songData.fetchedArtwork &&
            !this.props.songData.artworkError
        ) {
            this.props.dispatch(
                SongThunks.getArtwork(
                    this.props.currentPlaylist,
                    this.props.songData.Path
                )
            );
        }
    }
                ...
                <IconSection>
                    {this.props.currentPlaylist != 'All Songs' &&
                        <Icon
                            ...
                            y="0px"
                            role="img"
                            aria-label="delete song from playlist"
